...
```
*Project was done assuming it is the end of January 2020, and that MLS season would go on as planned before COVID-19*
...
skc2019 <- xgoals_teams %>% 
  filter(Team == "SKC", Season == 2019)
print(skc2019, width = Inf)
```
...
ggplot(keeper_ages, aes(x = Age, y=`G/xG`, label=ifelse(`G/xG`< .9 & Age >= 35,as.character(Player), ""))) +
  geom_point() +
  geom_text(size = 3) +
  xlim(30,42) +
  geom_text_repel()
